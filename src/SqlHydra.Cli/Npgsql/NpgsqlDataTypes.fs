...
let supportedTypeMappings isLegacy = // https://www.npgsql.org/doc/types/basic.html
    [//  ColumnTypeAlias                ClrType                                          DbType                  ProviderDbType                          ReaderMethod            ArrayBaseType
        ...
        "cidr",                         "System.Net.IPNetwork",                          DbType.Object,          Some (nameof NpgsqlDbType.Cidr),        nameof r.GetFieldValue, Some NpgsqlDbType.Cidr
        "inet",                         "System.Net.IPAddress",                          DbType.Object,          Some (nameof NpgsqlDbType.Inet),        nameof r.GetFieldValue, Some NpgsqlDbType.Inet
        "macaddr",                      "System.Net.NetworkInformation.PhysicalAddress", DbType.Object,          Some (nameof NpgsqlDbType.MacAddr),     nameof r.GetFieldValue, Some NpgsqlDbType.MacAddr
        "macaddr8",                     "System.Net.NetworkInformation.PhysicalAddress", DbType.Object,          Some (nameof NpgsqlDbType.MacAddr8),    nameof r.GetFieldValue, Some NpgsqlDbType.MacAddr8
        // skipped unsupported types
        ...
        "int8",                         "int64",                                         DbType.Int64,           Some (nameof NpgsqlDbType.Bigint),      nameof r.GetInt64,      Some NpgsqlDbType.Bigint
        "bool",                         "bool",                                          DbType.Boolean,         Some (nameof NpgsqlDbType.Boolean),     nameof r.GetBoolean,    Some NpgsqlDbType.Boolean
        "char",                         "string",                                        DbType.String,          Some (nameof NpgsqlDbType.Char),        nameof r.GetString,     Some NpgsqlDbType.Char
        "varchar",                      "string",                                        DbType.String,          Some (nameof NpgsqlDbType.Varchar),     nameof r.GetString,     Some NpgsqlDbType.Varchar
        "float8",                       "double",                                        DbType.Double,          Some (nameof NpgsqlDbType.Double),      nameof r.GetDouble,     Some NpgsqlDbType.Double
        "int",                          "int",                                           DbType.Int32,           Some (nameof NpgsqlDbType.Integer),     nameof r.GetInt32,      Some NpgsqlDbType.Integer
        "int4",                         "int",                                           DbType.Int32,           Some (nameof NpgsqlDbType.Integer),     nameof r.GetInt32,      Some NpgsqlDbType.Integer
        "decimal",                      "decimal",                                       DbType.Decimal,         Some (nameof NpgsqlDbType.Numeric),     nameof r.GetDecimal,    Some NpgsqlDbType.Numeric
        "float4",                       "float",                                         DbType.Single,          Some (nameof NpgsqlDbType.Real),        nameof r.GetFloat,      Some NpgsqlDbType.Real
        "int2",                         "int16",                                         DbType.Int16,           Some (nameof NpgsqlDbType.Smallint),    nameof r.GetInt16,      Some NpgsqlDbType.Smallint
        "timetz",                       "System.DateTime",                               DbType.DateTime,        Some (nameof NpgsqlDbType.TimeTz),      nameof r.GetDateTime,   Some NpgsqlDbType.TimeTz
        "timestamptz",                  "System.DateTime",                               DbType.DateTime,        Some (nameof NpgsqlDbType.TimestampTz), nameof r.GetDateTime,   Some NpgsqlDbType.TimestampTz
    ]
