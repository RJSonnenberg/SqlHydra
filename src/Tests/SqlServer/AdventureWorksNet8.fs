// This code was generated by `SqlHydra.SqlServer` -- v2.8.2.
...
type HydraReader(reader: Microsoft.Data.SqlClient.SqlDataReader) =
    ...
    member __.``dbo.AWBuildVersion`` = dbo.Readers.AWBuildVersionReader(reader, buildGetOrdinal typeof<dbo.AWBuildVersion>)
    member __.``dbo.DatabaseLog`` = dbo.Readers.DatabaseLogReader(reader, buildGetOrdinal typeof<dbo.DatabaseLog>)
    member __.``dbo.ErrorLog`` = dbo.Readers.ErrorLogReader(reader, buildGetOrdinal typeof<dbo.ErrorLog>)
    member __.``ext.DateTime2Support`` = ext.Readers.DateTime2SupportReader(reader, buildGetOrdinal typeof<ext.DateTime2Support>)
    member __.``ext.GetIdGuidRepro`` = ext.Readers.GetIdGuidReproReader(reader, buildGetOrdinal typeof<ext.GetIdGuidRepro>)
    member __.``ext.HierarchyIdSupport`` = ext.Readers.HierarchyIdSupportReader(reader, buildGetOrdinal typeof<ext.HierarchyIdSupport>)
